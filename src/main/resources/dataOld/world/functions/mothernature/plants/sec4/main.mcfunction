...
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:azalea_leaves run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treeaz"}',Tags:["mina"]}
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:flowering_azalea_leaves run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treeaz"}',Tags:["mina"]}
execute as @e[name=treeaz] if entity @e[name=dmain,scores={td=0..45}] run data merge entity @s {CustomName:'{"text":"treeplaz"}',Tags:["mina"]}
scoreboard players add @e[name=treeplaz] td 1
execute as @e[name=treeplaz,scores={td=1..1}] at @s run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treepltaz"}',Tags:["mina"]}
execute as @e[name=treeplaz] at @s run spreadplayers ~ ~ 0 15 false @e[name=treepltaz]
execute as @e[name=treeplaz,scores={td=3..}] at @s run kill @e[name=treepltaz,distance=0..15]
execute as @e[name=treeplaz,scores={td=4..}] run kill @s
...
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:bamboo run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treeba"}',Tags:["mina"]}
execute as @e[name=treeba] if entity @e[name=dmain,scores={td=0..45}] run data merge entity @s {CustomName:'{"text":"treeplba"}',Tags:["mina"]}
scoreboard players add @e[name=treeplba] td 1
execute as @e[name=treeplba,scores={td=1..1}] at @s run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treepltba"}',Tags:["mina"]}
execute as @e[name=treeplba] at @s run spreadplayers ~ ~ 0 15 false @e[name=treepltba]
execute as @e[name=treeplba,scores={td=3..}] at @s run kill @e[name=treepltba,distance=0..15]
execute as @e[name=treeplba,scores={td=4..}] run kill @s
...
execute as @e[name=treepltba] at @s if block ~ ~-1 ~ grass_block run fill ~ ~ ~ ~ ~ ~ bamboo_sapling replace
...
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:azalea_leaves run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"tree"}',Tags:["mina"]}
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:flowering_azalea_leaves run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"tree"}',Tags:["mina"]}
...
execute at @e[name=derp] if block ~ ~-1 ~ minecraft:bamboo run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"tree"}',Tags:["mina"]}
...
execute at @e[name=treepl] run fill ~ ~-10 ~ ~ ~ ~ air replace bamboo
...
execute as @e[name=derp,type=marker] at @s if block ~ ~-1 ~ minecraft:flowering_azalea run function world:mothernature/plants/growazalea