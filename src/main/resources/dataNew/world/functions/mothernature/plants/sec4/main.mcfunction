...
execute at @e[tag=decayPoint] run function world:mothernature/plants/sec4/main.0/9
execute as @e[name=treeaz] if entity @e[tag=dmain,scores={td=0..45}] run data merge entity @s {CustomName:'{"text":"treeplaz"}',Tags:["mina"]}
...
execute at @e[tag=decayPoint] if block ~ ~-1 ~ minecraft:bamboo run summon marker ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Marker:1b,Invisible:1b,PersistenceRequired:1b,CustomName:'{"text":"treeba"}',Tags:["mina"]}
execute as @e[name=treeba] if entity @e[tag=dmain,scores={td=0..45}] run data merge entity @s {CustomName:'{"text":"treeplba"}',Tags:["mina"]}
...
execute at @e[tag=decayPoint] run function world:mothernature/plants/sec4/main.0/65
...
execute at @e[name=treepl] run function world:mothernature/plants/sec4/main.0/72
...
function world:mothernature/plants/sec4/main.0/76
execute as @e[tag=dmain,scores={td=50..}] run scoreboard players set @s td 0
execute as @e[tag=decayPoint,type=marker] at @s if block ~ ~-1 ~ minecraft:flowering_azalea run function world:mothernature/plants/growazalea