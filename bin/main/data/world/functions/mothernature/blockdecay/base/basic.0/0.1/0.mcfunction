...
execute if block ~ ~-2 ~ #minecraft:dirt if block ~ ~-1 ~ rooted_dirt run fill ~ ~-1 ~ ~ ~-2 ~ dirt replace rooted_dirt
execute if block ~ ~-2 ~ #minecraft:dirt if block ~ ~-1 ~ coarse_dirt run fill ~ ~-1 ~ ~ ~-2 ~ rooted_dirt replace coarse_dirt
execute if block ~ ~-2 ~ #minecraft:dirt if block ~ ~-1 ~ sand run fill ~ ~-1 ~ ~ ~-2 ~ sand replace coarse_dirt
execute if block ~ ~-2 ~ minecraft:red_sand if block ~ ~-1 ~ sand run fill ~ ~-1 ~ ~ ~-2 ~ red_sand replace sand
execute if block ~ ~-2 ~ #minecraft:sand if block ~ ~-1 ~ gravel run fill ~ ~-1 ~ ~ ~-2 ~ sand replace gravel
execute if block ~ ~-2 ~ mca:redfinesand run fill ~ ~-2 ~ ~ ~-2 ~ air replace mca:redfinesand
execute if block ~ ~-2 ~ mca:humus run fill ~ ~-2 ~ ~ ~-2 ~ air replace mca:humus
execute if block ~ ~-2 ~ mca:finesand run fill ~ ~-2 ~ ~ ~-2 ~ air replace mca:finesand
execute if block ~ ~-2 ~ mca:loosegravel run fill ~ ~-2 ~ ~ ~-2 ~ air replace mca:loosegravel
